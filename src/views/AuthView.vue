      ...
      <div class="row">
        <div class="col-md-6 offset-md-3 col-xs-12">
          ...
          <p class="text-xs-center">
            <router-link :to="{ name: loginMode ? 'register' : 'login' }"
              >{{ loginMode ? 'Need' : 'Have' }} an account?</router-link
            >
          </p>
          ...
          <form @submit.prevent="doLogin">
            ...
            <button :disabled="disable" class="btn btn-lg btn-primary pull-xs-right">
